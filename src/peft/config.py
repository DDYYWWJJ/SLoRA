...
class PeftConfigMixin(PushToHubMixin):
    ...
    Args:
        peft_type (Union[[`~mora.utils.config.PeftType`], `str`]): The type of Peft method to use.
    """
...
class PeftConfig(PeftConfigMixin):
    ...
    Args:
        peft_type (Union[[`~mora.utils.config.PeftType`], `str`]): The type of Peft method to use.
        task_type (Union[[`~mora.utils.config.TaskType`], `str`]): The type of task to perform.
