...
class LoraConfig(PeftConfig):
    ...
    #modify add a new parameter  to Enable slora
    use_slora: bool = field(
        default=False,
        metadata={
            "help": (
                "Enable SLoRA"
    ...
    splice_position: int = field(
        default=0,
        metadata={
            "help": (
                "Splicing position，Refers to from splicing_position to splicing_position + 1"
            )
        },
    )
