    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        kwargs = {
            ...
            "use_rpeft": lora_config.use_rpeft,
            "use_dora": lora_config.use_dora,
            "use_mora": lora_config.use_mora,
            "mora_type": lora_config.mora_type,
            # modify
            "use_slora": lora_config.use_slora,
            "splice_ratio": lora_config.splice_ratio,
            "splice_position": lora_config.splice_position,
            "loaded_in_8bit": getattr(self.model, "is_loaded_in_8bit", False),
            "loaded_in_4bit": getattr(self.model, "is_loaded_in_4bit", False),
        }
        #print(getattr(self.model, "is_loaded_in_8bit", False),getattr(self.model, "is_loaded_in_4bit", False),'000000')
        ...
        if isinstance(target, LoraLayer) and not isinstance(target, AdaLoraLayer):
            ...
            # use_mora和mora_type参数在kwargs中
            new_module = self._create_new_module(lora_config, adapter_name, target, **kwargs)
            # print(f'the new_module is {new_module}')
            # print(f"adapter_name is {adapter_name}")
    ...
    def _create_new_module(lora_config, adapter_name, target, **kwargs):
        ...
        # print(f'new_module is {new_module}')
        return new_module
